defmodule Realworld.Blogs do
  ...
  def insert_article_with_tags(attrs) do
    insert_or_update_article_with_tages(%Article{}, attrs)
  end

  def insert_or_update_article_with_tages(article, attrs) do
    Ecto.Multi.new()
  ...
  def insert_and_get_all_tags(attrs) do
  ...
  def insert_or_update_article(article, attrs, %{tags: tags}) do
    article
    |> Article.changeset(attrs, tags)
    |> Repo.insert_or_update()
  end

  def insert_article_with_tags(tag_name) do
